...
//   });
//   var filterVal = document.getElementById("filterSelection").value;
//   document.getElementById('demo').innerHTML = "filter name: "+filterVal;
//   // var filter_selectIndex =document.getElementById("filterSelection").selectedIndex;
//   // var filter = document.getElementById("filterSelection").options[filter_selectIndex].value;
//   setSelected(document.getElementById("filterSelection").id);
//   injectFilter(`filters/${filterVal}.js`);
//   // popup-specific filters
//   applyFilter((window.selectedFilter = filterVal));
// };
...
filter.onclick = function() {
  ...
  // var filter = document.getElementById("filterSelection").options[filter_selectIndex].value;
  setSelected(document.getElementById("filterSelection").id);
  injectFilter(`colorblindFilter/filters/${filterVal}.js`);
  // popup-specific filters
  applyFilter((window.selectedFilter = filterVal));
};